//===-- LerosInstPrinter.cpp - Convert Leros MCInst to assembly syntax ----===//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an Leros MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#include "LerosInstPrinter.h"
...
void LerosInstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                     raw_ostream &O) {
...
void LerosInstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                           raw_ostream &O) {
